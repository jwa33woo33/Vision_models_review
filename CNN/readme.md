...
- The comparison between the standard convolutaion layer with batch normalization + Relu, and the depthwise separable convolution with depth wise and pointwise layers
